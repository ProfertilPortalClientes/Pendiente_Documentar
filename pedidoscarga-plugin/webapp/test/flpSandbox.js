		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#pedidoscargaplugin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pedidoscargaplugin-display": {
								"semanticObject": "pedidoscargaplugin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pedidoscargaplugin",
									"url": sap.ui.require.toUrl("pedidoscargaplugin")
								}
							}
						}
					}
